...
for machine_tag in machine_tags:
    ...
    try:
        affectedRows = system.db.runPrepUpdate(sql_query, [cell, area, machine, startTime, runMinutes, runTimePercent, idleMinutes, idleTimePercent, faultMinutes, faultTimePercent, output, target, performance, oee], "PowerBI2")
